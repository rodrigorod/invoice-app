<template>
    <div v-if="currentInvoice" class="invoice-view container">
        <router-link class="nav-link flex" :to="{name: 'Home'}">
            <img src="@/assets/icon-arrow-left.svg" alt="icon arrow left" /> Go back
        </router-link>
        ...
        <div class="header flex">
            <div class="left flex">
                <span>Status</span>
                <div class="status-button flex" :class="{paid: currentInvoice.invoicePaid, pending: currentInvoice.invoicePending, draft: currentInvoice.invoiceDraft}">
